...
#                      keep_default=False)
#
        # Adding field 'Post.date_time'
        db.add_column('blog_post', 'date_time',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
...
#
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Post.date_time'
        db.delete_column('blog_post', 'date_time')
    ...
    models = {
        ...
        'blog.post': {
            ...
            'date_time': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
